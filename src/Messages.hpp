...
/*   Updated: 2023/08/11 17:53:26 by lsordo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_NOSUCHNICK(nick, target)			(std::string (":irc42 401 " + nick + " " + target + " :No such nick"))
...
// # define NICK(user, nick)	(std::string(":" + user + " NICK :" + nick))
